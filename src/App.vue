<template>
  <div id="app">
    <persian-calendar :events-list="events" :display-period.sync="period" @on-day-click="addEvent">
    </persian-calendar>
...
@font-face {
  ...
  src: url('~vazir-font/dist/Vazir.eot?#iefix') format('embedded-opentype'),
    url('~vazir-font/dist/Vazir.woff2') format('woff2'), url('~vazir-font/dist/Vazir.woff') format('woff'),
